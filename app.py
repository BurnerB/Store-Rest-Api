...
from Resources.userEndpoints import UserRegister,User,UserLogin, TokenRefresh, UserLogout
...
app.config["PROPAGATE_EXCEPTIONS"] = True #Allow flask_jwt errors to raise and return specific errors to user
app.config["JWT_BLACKLIST_ENABLED"] = True
app.config["JWT_BLACKLIST_TOKEN_CHECKS"] = ["access","refresh"]
app.secret_key = "BABA" #app.config["JWT_SECRET_KEY"]
api = Api(app)
...
def add_claims_to_jwt(identity):
    if identity == 1:#instead of hardcoding read from database of admins or config file
